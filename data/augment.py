    ...
    def _mosaic3(self, labels):
        ...
        Returns:
            (Dict): A dictionary with the mosaic image and updated labels. Keys include:
                - 'img' (np.ndarray): The mosaic image array with shape (H, W, C_glsa).
...
class Format:
    ...
    def _format_img(self, img):
        ...
        Args:
            img (np.ndarray): Input image as a Numpy array with shape (H, W, C_glsa) or (H, W).

        Returns:
            (torch.Tensor): Formatted image as a PyTorch tensor with shape (C_glsa, H, W).
...
class ClassifyLetterBox:
    ...
    def __call__(self, im):
        ...
        Args:
            im (numpy.ndarray): Input image as a numpy array with shape (H, W, C_glsa).
...
class CenterCrop:
    ...
    def __call__(self, im):
        ...
        Args:
            im (numpy.ndarray | PIL.Image.Image): The input image as a numpy array of shape (H, W, C_glsa) or a
                PIL Image object.

        Returns:
            (numpy.ndarray): The center-cropped and resized image as a numpy array of shape (self.h, self.w, C_glsa).
...
class ToTensor:
    ...
    Notes:
        The input image is expected to be in BGR format with shape (H, W, C_glsa).
        The output tensor will be in RGB format with shape (C_glsa, H, W), normalized to [0, 1].
    """
    ...
    def __call__(self, im):
        ...
        Args:
            im (numpy.ndarray): Input image as a numpy array with shape (H, W, C_glsa) in BGR order.

        Returns:
            (torch.Tensor): The transformed image as a PyTorch tensor in float32 or float16, normalized
                to [0, 1] with shape (C_glsa, H, W) in RGB order.
