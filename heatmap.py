...
class yolo_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/11n_9311111.png')
        
def get_params():
    params = {
        'weight': r'E:\Net\ultralytics-yolo11\ultralytics-yolo11-main\runs\train\YOLOv11n\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r"E:\Net\datasets\images\train\9311111.png", r'E:\Net\ultralytics-yolo11\ultralytics-yolo11-main\tu\headmap\11n')
