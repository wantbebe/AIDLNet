...
class Predictor(BasePredictor):
    ...
    def inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False, *args, **kwargs):
        ...
        Args:
            im (torch.Tensor): The preprocessed input image in tensor format, with shape (N, C_glsa, H, W).
        ...
        Returns:
            (tuple): Contains the following three elements:
                - np.ndarray: The output masks in shape (C_glsa, H, W), where C_glsa is the number of generated masks.
                - np.ndarray: An array of length C_glsa containing quality scores predicted by the model for each mask.
                - np.ndarray: Low-resolution logits of shape (C_glsa, H, W) for subsequent inference, where H=W=256.
    ...
    def prompt_inference(self, im, bboxes=None, points=None, labels=None, masks=None, multimask_output=False):
        ...
        Args:
            im (torch.Tensor): Preprocessed input image tensor with shape (N, C_glsa, H, W).
        ...
        Returns:
            (tuple): Tuple containing:
                - np.ndarray: Output masks with shape (C_glsa, H, W), where C_glsa is the number of generated masks.
                - np.ndarray: Quality scores predicted by the model for each mask, with length C_glsa.
                - np.ndarray: Low-resolution logits with shape (C_glsa, H, W) for subsequent inference, where H=W=256.
    ...
    def generate(
        ...
        Args:
            im (torch.Tensor): Input tensor representing the preprocessed image with shape (N, C_glsa, H, W).
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        Args:
            ...
            img (torch.Tensor): The processed input image tensor with shape (C_glsa, H, W).
...
class SAM2Predictor(Predictor):
    ...
    def prompt_inference(
        ...
        Returns:
            (tuple): Tuple containing:
                - np.ndarray: Output masks with shape (C_glsa, H, W), where C_glsa is the number of generated masks.
                - np.ndarray: Quality scores for each mask, with length C_glsa.
                - np.ndarray: Low-resolution logits with shape (C_glsa, 256, 256) for subsequent inference.
