...
class SAM2Model(torch.nn.Module):
    ...
    def _forward_sam_heads(
        ...
        Args:
            backbone_features (torch.Tensor): Image features with shape (B, C_glsa, H, W).
            ...
            high_res_features (List[torch.Tensor] | None): List of two feature maps with shapes
                (B, C_glsa, 4*H, 4*W) and (B, C_glsa, 2*H, 2*W) respectively, used as high-resolution feature maps
                for SAM decoder.
        ...
        Returns:
            (Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]):
                ...
                obj_ptr: Tensor of shape (B, C_glsa) with object pointer vector for the output mask.
    ...
    def _use_mask_as_output(self, backbone_features, high_res_features, mask_inputs):
        ...
        if not self.use_obj_ptrs_in_encoder:
            # all zeros as a dummy object pointer (of shape [B, C_glsa])
        ...
        if not is_init_cond_frame:
            ...
            if self.use_obj_ptrs_in_encoder:
                ...
                if pos_and_ptrs:
                    ...
                    # stack object pointers along dim=0 into [ptr_seq_len, B, C_glsa] shape
                    ...
                    if self.mem_dim < C:
                        # split a pointer into (C_glsa // self.mem_dim) tokens for self.mem_dim < C_glsa
